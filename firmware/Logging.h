...
#define DEBUG_WHERE String(__FILE__)+":"+__LINE__
#define Log_Error(msg) Log.Error(__FILE__, __LINE__, msg)
#define Log_Info(msg) Log.Info(__FILE__, __LINE__, msg)
#define Log_Debug(msg) Log.Debug(__FILE__, __LINE__, msg)
#define Log_Verbose(msg) Log.Verbose(__FILE__, __LINE__, msg)
  ...
  public:
    ...
    */
    ...
    /**
      ...
      \return void
    */
    void Error(const char* file, int line, String msg, ...);
    ...
    /**
      ...
      \return void
    */
    void Info(const char* file, int line, String msg, ...);
    ...
    /**
      ...
      \return void
    */
    void Debug(const char* file, int line, String msg, ...);
    ...
    /**
      ...
      \return void
    */
    void Verbose(const char* file, int line, String msg, ...);


  private:
    void print(const char* file, int line, const char *format, va_list args);
    void print(const char* file, int line, String format, va_list args);
};
